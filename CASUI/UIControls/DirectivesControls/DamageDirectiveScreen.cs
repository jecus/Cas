...
namespace CAS.UI.UIControls.DirectivesControls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class DamageDirectiveScreen : UserControl
    {
        #region Fields
        ...
        private readonly DamageDirectiveSummaryInformationControl summaryDirectiveControl;
        /// <summary>
        /// </summary>
        ...
        #region public DamageDirectiveScreen(BaseDetailDirective directive)

        ///<summary>
        /// Создает страницу для отображения информации об одной директиве
        ///</summary>
        /// <param name="directive">Директива</param>
        public DamageDirectiveScreen(BaseDetailDirective directive)
        {
            if (directive == null)
            ...
            summaryDirectiveControl = new DamageDirectiveSummaryInformationControl(directive);
            generalDataAndPerformanceControl = new DamageDirectiveGeneralInformationControl(directive);
