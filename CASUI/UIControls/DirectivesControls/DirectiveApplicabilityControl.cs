...
namespace CAS.UI.UIControls.DirectivesControls
{
    ...
    public class DirectiveApplicabilityControl : UserControl
    {
        ...
        {
            currentOperator = aircraft.Operator;
        ...
        public void ClearFields()
        {
            ...
            for (int i = 0; i < currentOperator.Aircrafts.Count; i++)
            {
                //
                // checkBox
                //
                ...
                checkBox.Text = currentOperator.Aircrafts[i].RegistrationNumber;
                ...
                checkBox.Tag = currentOperator.Aircrafts[i];
                checkBox.Checked = true;
                if (currentOperator.Aircrafts[i].ID == currentAircraft.ID)
        ...
        private RecordType GetRecordType(string recordTypeName)
        {
            if (recordTypeName == OPEN_STATUS)
                ...
                return RecordTypesCollection.Instance.DirectiveNotApplicableRecordType;
            else if (recordTypeName == TERMINATED_STATUS)
                return RecordTypesCollection.Instance.DirectiveTerminatingType;
            else
                return RecordTypesCollection.Instance.DirectiveClosingRecordType;
        }
