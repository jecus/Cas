...
{
    internal class DirectiveListView : SDList<BaseDetailDirective>, IReference
    {
        #region Fields
        ...
        #region public DirectiveListView()
        /// <summary>
        /// Создает элемент управления отображающий listview
        /// </summary>
        public DirectiveListView()
        {
            sortMultiplier = -1;
        ...
        #region public DirectiveListView(BaseDetailDirective[] directiveArray, BaseDetail parentBaseDetail)
        /// <summary>
        ...
        public DirectiveListView(BaseDetailDirective[] directiveArray) : this()
        {
