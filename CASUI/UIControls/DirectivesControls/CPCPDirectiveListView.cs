...
namespace CAS.UI.UIControls.DirectivesControls
{
    ...
    ///</summary>
    public class CPCPDirectiveListView : SDList<BaseDetailDirective> , IReference
    {

        #region Fields

        private readonly float[] HEADER_WIDTH = new float[] {0.2f, 0.43f, 0.05f, 0.1f, 0.1f, 0.1f};
        ...
        #region public CPCPDirectiveListView()

        /// <summary>
        /// Создает элемент управления отображающий список CPCP директив
        /// </summary>
        public CPCPDirectiveListView()
        {
...
/*            List<AbstractDetail> containedDetails = new List<AbstractDetail>();
        ...
        private static string[] GetItemString(BaseDetailDirective item)
        {
            ...
            return new string[]
                {item.Paragraph!="" ? item.Title+" Part "+item.Paragraph:item.Title, 
                    item.Description,
                    item.ManHours.ToString(), 
        ...
        private void ComponentStatusListView_DisplayerRequested(object sender, ReferenceEventArgs e)
        {
            ...
            e.RequestedEntity = new DispatcheredCPCPDirectiveScreen(SelectedItem);
        }
