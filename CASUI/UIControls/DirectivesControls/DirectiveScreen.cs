...
namespace CAS.UI.UIControls.DirectivesControls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class DirectiveScreen : UserControl
    {
        #region Fields
        ...
        private readonly DirectiveSummary summaryDirectiveControl;
        /// <summary>
        /// </summary>
        protected readonly DirectiveInformationControl generalDataAndPerformanceControl;
        private readonly DirectiveComplianceListView complianceDirectiveControl;
        /// <summary>
        /// </summary>
        protected readonly DirectiveParametersControl attributesAndParametersControl;
        ...
        #region public DirectiveScreen(BaseDetailDirective directive)
        ...
        #region private BaseDetailDirective GetDirectiveByTitle(string title)
