...
namespace CAS.UI.UIControls.Auxiliary
{
    partial class CopyrightControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelCopyrights.Text = (string)(new TermsProvider()["Copyright"]);
            ...
            this.labelVersionInfo.Text = (string) new TermsProvider()["SystemName"]
                                         + " v" + (string)new TermsProvider()["ProductVersion"] + "." + (string)new GlobalTermsProvider()["ProductBuild"];
            ...
            this.linkLabelSupport.Text = (string)new TermsProvider()["ProductWebsite"];
