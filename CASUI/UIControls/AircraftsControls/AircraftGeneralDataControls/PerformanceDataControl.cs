...
{
    /// <summary>
    /// Элемент управления для отображения PerformanceDataControl ВС
    /// </summary>
    public partial class PerformanceDataControl : PictureBox
    {
        ...
        /// <summary>
        /// Создает элемент управления для отображения PerformanceDataControl ВС
        /// </summary>
        /// <param name="currentAircraft"></param>
        public PerformanceDataControl(Aircraft currentAircraft)
        {
