...
{
    /// <summary>
    /// Элемент управления для отображения Interior Configuration ВС
    /// </summary>
    public partial class InteriorConfigurationControl : PictureBox
    {
        ...
        /// <summary>
        /// Создает элемент управления для отображения Interior Configuration ВС
        /// </summary>
        public InteriorConfigurationControl(Aircraft currentAircraft)
        {
