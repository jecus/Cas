...
{
    public class DispatcheredOutOffPhaseReferencAdding : OutOffPhaseReferencAdding, IDisplayingEntity
    {

        #region Constructors

        #region public DispatcheredOutOffPhaseReferencAdding(Aircraft parentAircraft) : base(parentAircraft)
        ...
        public DispatcheredOutOffPhaseReferencAdding(Aircraft parentAircraft) : base(parentAircraft)
        {
        }

        #endregion

        #region public DispatcheredOutOffPhaseReferencAdding(BaseDetail parentBaseDetail) : base(parentBaseDetail)

        ///<summary>
        /// Создается объект, описывающий отображение добавления директивы
        ///</summary>
        /// <param name="parentBaseDetail">Родительский объект, в который добавляется директива</param>
        public DispatcheredOutOffPhaseReferencAdding(BaseDetail parentBaseDetail) : base(parentBaseDetail)
        {
        }
