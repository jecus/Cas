...
{
    public class DispatcheredDamageDirectiveAddingScreen : DamageDirectiveAddingScreen, IDisplayingEntity
    {

        #region Constructors

        #region public DispatcheredDamageDirectiveAddingScreen(Aircraft parentAircraft) : base(parentAircraft)
        ...
        public DispatcheredDamageDirectiveAddingScreen(Aircraft parentAircraft) : base(parentAircraft)
        {
        }

        #endregion

        #region public DispatcheredDamageDirectiveAddingScreen(BaseDetail parentBaseDetail) : base(parentBaseDetail)

        ///<summary>
        /// Создается объект, описывающий отображение добавления директивы
        ///</summary>
        /// <param name="parentBaseDetail">Родительский объект, в который добавляется директива</param>
        public DispatcheredDamageDirectiveAddingScreen(BaseDetail parentBaseDetail) : base(parentBaseDetail)
        {
        }
        ...
        {
            if (!(obj is DispatcheredDamageDirectiveAddingScreen))
                return false;
