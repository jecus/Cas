...
namespace CAS.UI.Management.Dispatchering.DispatcheredUIControls.Reports
{
    ...
    /// </summary>
    public partial class DispatcheredModificationItemsReport : UserControl, IDisplayingEntity
    {
        #region Fields

        private readonly ModificationItemsReportBuilder builder;
        ...
        {
            if (!(obj is DispatcheredModificationItemsReport)) 
                return false;
            return builder.Equals(((DispatcheredModificationItemsReport)obj).builder);
        }
