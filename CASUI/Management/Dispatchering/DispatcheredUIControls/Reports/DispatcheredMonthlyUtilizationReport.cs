...
namespace CAS.UI.Management.Dispatchering.DispatcheredUIControls.Reports
{
    ...
    /// </summary>
    public partial class DispatcheredMonthlyUtilizationReport : UserControl ,IDisplayingEntity
    {
        #region Fields
        ...
        /// </summary>
        protected DispatcheredMonthlyUtilizationReport()
        {
            InitializeComponent();
            Dock = DockStyle.Fill;
        }
        ...
        /// </summary>
        public MonthlyUtilizationBuilder ReportBuilder
        {
            get
            {
        ...
        public bool ContainedDataEquals(IDisplayingEntity obj)
        {
            if (!(obj is DispatcheredDetailListReport))
                return false;
            return ((obj as DispatcheredMonthlyUtilizationReport).reportBuilder == reportBuilder);
