...
namespace CAS.UI.Management.Dispatchering
{
    internal class DisplayDispatcher: IDispatcher
    {
        ...
        private IDisplayer currentDisplayer;
        private bool useChangePositionCapability = false;
        ...
        internal override void ProcessControl(Control control)
        {
            if (control is IReference)
            {
                ...
                //if (reference.DisplayerRequested.Method.Equals(reference_DisplayerRequestedEventHandler))
        ...
        /// <summary>
        /// Try to select Displayer for entity or add new one
        /// </summary>
        ...
        #region void defaultProxy_DisplayerSelected(object sender, DisplayerEventArgs e)

        void defaultProxy_DisplayerSelected(object sender, DisplayerEventArgs e)
        {
            if (!useEvent)
            {
        ...
        #region void defaultProxy_DisplayerDeleted(object sender, DisplayerEventArgs e)

        void defaultProxy_DisplayerDeleted(object sender, DisplayerEventArgs e)
        {
