...
namespace CAS.UI.Management.Dispatchering
{
    ...
    {
        private bool closingCanBeCanceled;
        ...
        {
            get { return base.SelectedTab as IDisplayer; }
            set { Select(value); }
        }
        #endregion
        ...
        public IDisplayer[] ContainedDisplayers
        {
            get
            {
                IDisplayer[] tabPages = new IDisplayer[base.TabCount];
                for (int i = 0; i < base.TabPages.Count; i++)
                {
                    IDisplayer displayer = base.TabPages[i] as IDisplayer;
        ...
        {
            get { return closingCanBeCanceled; }
            set { closingCanBeCanceled = value; }
        }
        ...
        protected override void OnControlAdded(ControlEventArgs e)
        {
            ...
            {
                CloseTab(e.Control as AvTabPage);
                Invalidate();
            }
        }
        #endregion
        ...
        {
            if (objectToSelect is AvTabPage)
                SelectTab(objectToSelect as AvTabPage);
        }
        ...
        {
            AvTabPage displayerPage = displayer as AvTabPage;
        ...
        public void Add(IDisplayer displayer)
        {
            ...
            if (!(displayer is AvTabPage)) throw new ArgumentException("Displayer must be AvTabPage");
            if (Contains(displayer)) Select(displayer);
            TabPages.Add(displayer as AvTabPage);
        }
        ...
        public bool Remove(IDisplayer displayer, bool performCloseChecking)
        {
            ...
            CloseTab(displayer as AvTabPage);
            return !TabPages.Contains(displayer as AvTabPage);
        }
        ...
        #region public override AvTabPage CreateNewTabPage(string caption)
        ...
        public override AvTabPage CreateNewTabPage(string caption)
        {
        ...
        #region public override AvTabPage CreateNewTabPage()

        ///<summary>
        /// New object of tab page is created
        ///</summary>
        ///<returns>Created object</returns>
        public override AvTabPage CreateNewTabPage()
        {
