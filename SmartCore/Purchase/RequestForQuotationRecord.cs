...
namespace SmartCore.Purchase
{
	...
	public class SupplierPrice : BaseEntityObject
	{
		...
		{
			СurrencyNew = Сurrency.USD;
			СurrencyServ = Сurrency.USD;
			СurrencyOH = Сurrency.USD;
			СurrencyRepair = Сurrency.USD;
		}
		...
		{
			return $"{CostNew}/{CostNewEx}/{СurrencyNew}/{CostNewReadiness}";
		}

		private string GetServPriceString()
		{
			return $"{CostServiceable}/{CostServiceableEx}/{СurrencyServ}/{CostServiceableReadiness}";
		}

		private string GetOHPriceString()
		{
			return $"{CostOverhaul}/{CostOverhaul}/{СurrencyOH}/{CostOverhaulReadiness}";
		}

		private string GetRepairPriceString()
		{
			return $"{CostRepair}/{CostRepairEx}/{СurrencyRepair}/{CostRepairReadiness}";
		}
