...
namespace SmartCore.Entities.General.Templates
{
    ...
    public class TemplateBaseComponent : BaseEntityObject, IKitRequired, IComparable<Accessory.Component>
    {
        ...
        */
        ...
        #region public Int32 ATAChapter { get; set; }
        /// <summary>
        /// Внешний ключ на идентификатор записи со справочной информацией
        /// </summary>
        [TableColumnAttribute("ATAChapterId"), ListViewData("ATAChapter")]
        ...
        public bool IsBaseComponent { get; internal set; }
        #endregion
        ...
        /// 
        /// </summary>
        [TableColumnAttribute("CostOverhaul"), ListViewData("Cost Overhaul"), MinMaxValue(0, 1000000000)]
        ...
        /// 
        /// </summary>
        [TableColumnAttribute("CostServiceable"), ListViewData("Cost Serviceable"), MinMaxValue(0, 1000000000)]
        ...
        /// 
        /// </summary>
        [TableColumnAttribute("ManHours"), ListViewData("Mans Hours"), MinMaxValue(0, 1000000000)]
		...
		/// 
		/// </summary>
		[TableColumnAttribute("FaaFormFileId")]
        ...
        /// </summary>
        [TableColumnAttribute("WarrantyNotify"), ListViewData("Warranty Notify")]
        ...
        /// 
        /// </summary>
        public SupplierCollection Supplier { get; set; }
        #endregion
		...
		#region Чаксть базовой детали

		#region public BaseComponentType BaseComponentType { get; set; }
		/// <summary>
		/// Тип базового агрегата
		/// </summary>
		[TableColumnAttribute("BaseComponentTypeId")]
        public BaseComponentType BaseComponentType { get; set; }
		#endregion

		#endregion

		#region public TemplateBaseComponent()
		/// <summary>
		/// Создает воздушное судно без дополнительной информации
		/// </summary>
		public TemplateBaseComponent()
        {
		...
		#region public List<TemplateComponentDirective> ComponentDirectives { get; set; }
		public List<TemplateComponentDirective> ComponentDirectives { get; set; }

        #endregion

        #region public List<TemplateDirective> Directives { get; set; }
        public List<TemplateDirective> Directives { get; set; }

		#endregion

		#region public List<TemplateComponent> Components { get; set; }
        ...
        public string KitParentString
        {
            get
            {
                return string.Format("Templ. Base Compnt.:{0} {1}", this, Description);
            }
        }
        #endregion
