...
namespace SmartCore.Entities.Dictionaries
{
    ...
    /// <summary>
    /// Описывает тип события системы безопасности полетов
    /// </summary>
    [Table("SmsEventTypes", "dbo", "ItemId")]
	[Dto(typeof(SmsEventTypeDTO))]
    public class SmsEventType : AbstractDictionary, IComparable<SmsEventType>
    {
        ...
        */
        ...
        public int CompareTo(SmsEventType y)
        {
