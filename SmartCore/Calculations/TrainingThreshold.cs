...
{
	[Serializable]
	public class TrainingThreshold : IThreshold
	{
		...
		*/
		...
		public TrainingThreshold(ComponentDirectiveThreshold source)
		{
		...
		public TrainingThreshold(byte[] bytes)
		{
