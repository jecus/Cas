...
namespace CAA.Entity.Core
{
	public class DataContext : DbContext
	{
        ...
        public DbSet<CAAWorkPackageRecordDTO> CAAWorkPackageRecordDto { get; set; }
        public DbSet<CAAWorkPackageDTO> CAAWorkPackageDto { get; set; }
        ...
        public DbSet<CheckListRevisionDTO> CheckListRevisionDtos { get; set; }
        public DbSet<CheckListRevisionRecordDTO> CheckListRevisionRecordDtos { get; set; }
        public DbSet<CAAAuditRecordDTO> AuditRecordDtos { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EducationDTO>()
                ...
                .WithMany(i => i.EducationDtos)
                .HasForeignKey(i => i.OccupationId);
