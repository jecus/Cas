...
namespace CAS.UI.UIControls.Auxiliary.Comparers
{
    ...
    ///</summary>
    public class BaseDataGridViewRowComparer : IComparer<DataGridViewRow>
    {
        #region Fields
        ...
        public BaseDataGridViewRowComparer(int columnIndex, int sortMultiplier)
        {
        ...
        public virtual int Compare(DataGridViewRow x, DataGridViewRow y)
        {
