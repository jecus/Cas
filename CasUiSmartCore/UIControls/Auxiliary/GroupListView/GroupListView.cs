...
namespace CAS.UI.UIControls.Auxiliary.GroupListView
{
    public class ListGroup : ListView
    {
            ...
            : base()
        {
            ...
            this.SmallImageList.Images.Add(COLLAPSED_IMAGE_KEY, Properties.Resources.GreenPlusSmall);
            this.SmallImageList.Images.Add(EXPANDED_IMAGE_KEY, Properties.Resources.RedMinusSmall);
            this.SmallImageList.Images.Add(EMPTY_IMAGE_KEY, Properties.Resources.DeleteIconGraySmall);
