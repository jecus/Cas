...
namespace CAS.UI.UIControls.Auxiliary
{
    partial class CopyrightControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelCopyrights.Text = (string)(new GlobalTermsProvider()["Copyright"]);
            ...
            this.labelVersionInfo.Size = new System.Drawing.Size(350, 20);
            this.labelVersionInfo.TabIndex = 0;
            this.labelVersionInfo.Text = (string) new GlobalTermsProvider()["SystemName"]
                                         + " v" + (string)new GlobalTermsProvider()["ProductVersion"] + "." + (string)new GlobalTermsProvider()["ProductBuild"];
            ...
            this.linkLabelSupport.Text = (string)new GlobalTermsProvider()["ProductWebsite"];
