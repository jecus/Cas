...
namespace CAS.UI.UIControls.Reliability
{
    ...
    ///</summary>
    [ToolboxItem(false)]
    public partial class OccurrencesListScreen : ScreenControl
    {
		...
		#region public OccurrencesListScreen()
		///<summary>
		/// Конструктор по умолчанию
		///</summary>
		public OccurrencesListScreen()
        {
            InitializeComponent();
        }
		#endregion

		#region public OccurrencesListScreen(Aircraft Operator op)
		public OccurrencesListScreen(Operator op)
            : this()
        {
            if (op == null)
