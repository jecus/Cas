...
namespace CAS.UI.UIControls.Discrepancies
{
    ...
    ///</summary>
    [ToolboxItem(false)]
    public partial class EventListScreen : ScreenControl
    {
		...
		#region public EventListScreen(Aircraft Operator op)
		public EventListScreen(Operator op)
            : this()
        {
            if (op == null)
