...
namespace CAS.UI.UIControls.ForecastControls
{
	...
	///</summary>
	[ToolboxItem(false)]
	public partial class ForecastListScreenMtopOld : ScreenControl
	{
		#region Fields
		...
		private ForecastMTOPListViewOld _directivesViewer;
		...
		#region public ForecastListScreenMtopOld()
		///<summary>
		/// Конструктор по умолчанию
		///</summary>
		public ForecastListScreenMtopOld()
		{
			InitializeComponent();
		}
		#endregion
		...
		public ForecastListScreenMtopOld(BaseEntityObject currentContainer, DirectiveType directiveType)
			: this()
		{
		...
		{
			_directivesViewer = new ForecastMTOPListViewOld
			{
		...
		private void HeaderControlButtonPrintDisplayerRequested(object sender, ReferenceEventArgs e)
		{
			...
			if (sender == itemPrintReportSchedule)
			{
				...
				GlobalObjects.AuditRepository.WriteReportAsync(GlobalObjects.CasEnvironment.IdentityUser, "ForecastListScreenMtopOld (Scheduled)");
			}
			else if (sender == itemPrintReportMaintenancePlan)
			{
				...
				GlobalObjects.AuditRepository.WriteReportAsync(GlobalObjects.CasEnvironment.IdentityUser, "ForecastListScreenMtopOld (Maintenance Plan)");
			}
			else if (sender == itemPrintReportEquipmentAndMaterials)
			{
				...
				GlobalObjects.AuditRepository.WriteReportAsync(GlobalObjects.CasEnvironment.IdentityUser, "ForecastListScreenMtopOld (Equipment and Materials)");
			}
			else if (sender == _itemPrintComponents)
			{
				...
				GlobalObjects.AuditRepository.WriteReportAsync(GlobalObjects.CasEnvironment.IdentityUser, "ForecastListScreenMtopOld (Components)");
			}
			else
			{
				e.Cancel = true;
