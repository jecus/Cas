...
namespace CAS.UI.UIControls.Fleet
{
	...
	///</summary>
	public partial class MaintenanceDirectiveFleetListView : BaseGridViewControl<MaintenanceDirective>
	{
		#region Fields
		...
		#region public MaintenanceDirectiveFleetListView()
		///<summary>
		///</summary>
		public MaintenanceDirectiveFleetListView()
		{
			InitializeComponent();
		}
		#endregion
