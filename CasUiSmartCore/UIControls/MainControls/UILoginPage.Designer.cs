...
namespace CAS.UI.UIControls.MainControls
{
    internal partial class UILoginPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelName.Text = new GlobalTermsProvider()["SystemName"].ToString().Replace(" ", Environment.NewLine);
            // 
            // panelDescription
            // 
            ...
            this.referenceLoginControl.Connected += DispatcheredLoginControlConnected;
