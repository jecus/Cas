...
namespace CAS.UI.UIControls.MaintenanceControlCenterControls
{
    ...
    ///</summary>
    public partial class AircraftMaintenanceControlListView : BaseListViewControl<BaseEntityObject>
    {
        #region Fields
        ...
        protected override void SetHeaders()
        {
            ...
            ColumnHeader columnHeader = new ColumnHeader { Width = 75, Text = "ATA" };
            ColumnHeaderList.Add(columnHeader);

            columnHeader = new ColumnHeader { Width = 100, Text = "Title" };
            ColumnHeaderList.Add(columnHeader);

            columnHeader = new ColumnHeader { Width = 125, Text = "Description" };
            ColumnHeaderList.Add(columnHeader);
