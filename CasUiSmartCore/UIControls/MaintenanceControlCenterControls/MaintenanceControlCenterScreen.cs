...
namespace CAS.UI.UIControls.MaintenanceControlCenterControls
{
    ///<summary>
    ///</summary>
    public partial class MaintenanceControlCenterScreen : ScreenControl
    {
        #region Fields

        private bool _needReload;
        private Operator _currentItem;
        ...
        #region private MaintenanceControlCenterScreen()
        ///<summary>
        ///</summary>
        private MaintenanceControlCenterScreen()
        {
            InitializeComponent();
        }
        #endregion

        #region public MaintenanceControlCenterScreen(Aircraft aircraft) : this ()

        ///<summary>
        /// Создает страницу для отображения информации об одной директиве
        ///</summary>
        /// <param name="operator">Директива</param>
        public MaintenanceControlCenterScreen(Operator @operator)
            : this()
        {
            if (@operator == null)
        ...
        protected override void AnimatedThreadWorkerRunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (flowLayoutPanelMain.Controls.Count == 0)
            {
                ...
                {
                    AircraftMaintenanceControl aircraftMaintenanceControl = new AircraftMaintenanceControl();
                    flowLayoutPanelMain.Controls.Add(aircraftMaintenanceControl);
                    // Добавляем разделитель
                    if (i > 0)
                    {
                        aircraftMaintenanceControl.Extended = false;
                    }
                    aircraftMaintenanceControl.EnableExtendedControl = aircrafts.Count >= 2;
                    aircraftMaintenanceControl.Aircraft = aircrafts[i];
                }
            }
        ...
        protected override void AnimatedThreadWorkerDoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    //_currentItem = GlobalObjects.CasEnvironment.Loader.GetObject<Specialist>(_currentItem.ItemId, true);
                }
            }
            catch (Exception ex)
            {
        ...
        private void Initialize()
        {
            ...
            StatusTitle = "Maintenance Control Center";  
        ...
        //        !CategoriesControl.ValidateData(out message))
        //    {
        //        return false;
        //    }
            return true;
        ...
        private bool GetChangeStatus()
        {
            ...
            //    CategoriesControl.GetChangeStatus())
            //{
            //    return true;
            //}
            return false;
        ...
        private bool SaveData()
        {
            ...
            //    foreach (CategoryRecord categoryRecord in _currentItem.CategoriesRecords)
            //    {
            //        categoryRecord.Employee = _currentItem;
