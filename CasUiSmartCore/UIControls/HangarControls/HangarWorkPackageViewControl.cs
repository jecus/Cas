...
namespace CAS.UI.UIControls.HangarControls
{
    ...
    ///</summary>
    [Designer(typeof(HangarWorkPackageViewControlDesigner))]
    public partial class HangarWorkPackageViewControl : CommonDataGridViewControl
    {
        #region Fields
        ...
        #region public HangarWorkPackageViewControl()
        ///<summary>
        /// конструктор по умолчанию для простого создания ЭУ в Дизайнере
        ///</summary>
        public HangarWorkPackageViewControl()
        {
            InitializeComponent();
        }
        #endregion

        #region public HangarWorkPackageViewControl(PropertyInfo beginGroup) : this()
        ///<summary>
        /// конструктор по умолчанию для простого создания ЭУ в Дизайнере
        ///</summary>
        ///<param name="beginGroup">Задает своиство класса, по которому нужно сделать первичную группировку</param>
        public HangarWorkPackageViewControl(PropertyInfo beginGroup)
            : this()
        {
        ...
        protected override void SetHeaders()
        {
            try
            {
                ...
                columnHeader = new DataGridViewTextBoxColumn();
                columnHeader.DefaultCellStyle.WrapMode = DataGridViewTriState.True;
                columnHeader.Width = (int)(dataGridView.Width * 0.16f);
    ...
    internal class HangarWorkPackageViewControlDesigner : ControlDesigner
    {
