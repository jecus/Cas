...
namespace CAS.UI.UIControls.HangarControls
{
    ///<summary>
    ///</summary>
    public partial class HangarScreen : ScreenControl
    {
        #region Fields

        private bool _needReload;
        private Hangar _currentItem;
        ...
        #region private HangarScreen()
        ///<summary>
        ///</summary>
        private HangarScreen()
        {
            InitializeComponent();
        }
        #endregion

        #region public HangarScreen(Hangar hangar) : this ()

        ///<summary>
        /// Создает страницу для отображения информации об одной директиве
        ///</summary>
        /// <param name="hangar">Директива</param>
        public HangarScreen(Hangar hangar)
            : this()
        {
            if (hangar == null)
                throw new ArgumentNullException("hangar", "Argument cannot be null");

            aircraftHeaderControl1.Operator = hangar.Operator;
            
            CurrentParent = hangar;
        ...
        protected override void AnimatedThreadWorkerRunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            hangarMaintenanceListControl.Hangar = CurrentParent as Hangar;
        }
        #endregion
