...
namespace CAS.UI.UIControls.PurchaseControls
{
	partial class PurchaseOrderListScreen
	{
		...
		private void InitializeComponent()
		{
			...
			this.headerControl.ReloadButtonClick += new System.EventHandler(this.HeaderButtonReloadClick);
			this.headerControl.PrintButtonDisplayerRequested += new System.EventHandler<Interfaces.ReferenceEventArgs>(this.HeaderControlButtonPrintRequested);
			// 
			// flowLayoutPanel1
			// 
