...
{
	partial class RequestOffersListScreen
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.headerControl.ReloadButtonClick += new System.EventHandler(this.HeaderQuotationButtonReloadClick);
			this.headerControl.PrintButtonDisplayerRequested += new System.EventHandler<Interfaces.ReferenceEventArgs>(this.HeaderQuotationButtonPrintDisplayerRequested);
			// 
			// flowLayoutPanel1
			// 
			...
			// 
			// RequestOffersListScreen
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Name = "RequestOffersListScreen";
