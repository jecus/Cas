        ...
        protected override void SetRowBackColor(TreeDataGridViewRow treeDataGridViewRow, BaseEntityObject item)
        {
            ...
            if (item is NextPerformance)
            {
                ...
                if (nextPerformance.Parent.IsDeleted)
                {
                    ...
                    treeDataGridViewRow.Cells[0].ToolTipText += string.Format("This {0} is deleted", nextPerformance.Parent.SmartCoreObjectType);
                }
            }
            else if (item is AbstractPerformanceRecord)
            {
                ...
                if (apr.Parent.IsDeleted)
                {
                    ...
                    if (treeDataGridViewRow.Cells[0].ToolTipText.Trim() != "")
                        treeDataGridViewRow.Cells[0].ToolTipText += "\n";
                    treeDataGridViewRow.Cells[0].ToolTipText += string.Format("This {0} is deleted", apr.Parent.SmartCoreObjectType);
                }    
            }
            else
            {
                ...
                if (item.IsDeleted)
                {
                    ...
                    if (treeDataGridViewRow.Cells[0].ToolTipText.Trim() != "")
                        treeDataGridViewRow.Cells[0].ToolTipText += "\n";
                    treeDataGridViewRow.Cells[0].ToolTipText += string.Format("This {0} is deleted", item.SmartCoreObjectType);
                }
            }
        }
        #endregion
