...
namespace CAS.UI.UIControls.CommercialControls
{
    ///<summary>
    ///</summary>
    [Designer(typeof(RequestControlDesigner))]
    public partial class RequestControl : UserControl, IReference
    {
        ...
        private Request _currentDirective;

        #endregion

        #region Constructors

        #region public RequestControl()
        ...
        #region public Request CurrentDirective
        ///<summary>
        ///Текущая директива
        ///</summary>
        public Request CurrentDirective
        {
            set
            {
        ...
        public void ApplyChanges()
        {
            ...
            _currentDirective.RequestHeader = textboxWorkOrderHeader.Text;
        ...
        private void ButtonDeleteTaskClick(object sender, EventArgs e)
        {
            ...
            if (confirmResult == DialogResult.Yes)
            {
                try
                {
                    GlobalObjects.PackageCore.DeleteFromDirectivePackage<Request, RequestRecord>(workOrderViewControl.SelectedItems.ToArray(), _currentDirective);
                }
                catch (Exception ex)
                {
                    Program.Provider.Logger.Log("Error while deleting data", ex);
    ...
    #region internal class RequestControlDesigner : ControlDesigner

    internal class RequestControlDesigner : ControlDesigner
    {
