...
{
    partial class DirectivePackageBindTaskFormNew
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.listViewTasksForSelect = new CAS.UI.UIControls.CommercialControls.DirectivePackageBindTaskDataGridView();
			this.SuspendLayout();
			// 
			// buttonAdd
			// 
			...
			// 
			this.listViewTasksForSelect.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
			...
			this.listViewTasksForSelect.Location = new System.Drawing.Point(1, 64);
			...
			this.listViewTasksForSelect.ShowAddNew = false;
			this.listViewTasksForSelect.ShowGroups = true;
			this.listViewTasksForSelect.Size = new System.Drawing.Size(1003, 613);
			...
			// 
			// DirectivePackageBindTaskFormNew
			// 
			...
			this.Name = "DirectivePackageBindTaskFormNew";
			this.Resizable = false;
			this.ShowIcon = false;
			this.Text = "Directive Package Select Task Form";
			this.Activated += new System.EventHandler(this.TemplateAircraftAddToDataBaseFormActivated);
			this.Deactivate += new System.EventHandler(this.TemplateAircraftAddToDataBaseFormDeactivate);
        ...
        private DirectivePackageBindTaskDataGridView listViewTasksForSelect;
    }
}