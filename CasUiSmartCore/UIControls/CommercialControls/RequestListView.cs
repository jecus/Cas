...
namespace CAS.UI.UIControls.CommercialControls
{
    ...
    ///</summary>
    public partial class RequestListView : BaseListViewControl<Request>
    {
        #region Fields
		...
		protected override void SetGroupsToItems(int columnIndex)
        {
            ...
            {
                switch (((Request)item.Tag).Status)
                {
        ...
        protected override void FillDisplayerRequestedParams(ReferenceEventArgs e)
        {
            ...
            {
                Request item = SelectedItem;
                e.TypeOfReflection = ReflectionTypes.DisplayInNew;
                e.DisplayerText = item.Title;
                e.RequestedEntity = new RequestScreen(item);
            }
        }
        #endregion
