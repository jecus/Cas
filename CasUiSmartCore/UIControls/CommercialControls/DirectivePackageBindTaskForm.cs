...
namespace CAS.UI.UIControls.CommercialControls
{
    ...
    /// </summary>
    public partial class DirectivePackageBindTaskForm : MetroForm
    {
        ...
        #region private DirectivePackageBindTaskForm()

        /// <summary>
        /// Создает форму для переноса шаблона ВС в рабочую базу данных
        /// </summary>
        private DirectivePackageBindTaskForm()
        {
            InitializeComponent();
        }
        ...
        #region public DirectivePackageBindTaskForm(IDirectivePackage directivePackage) : this()

        /// <summary>
        /// Создает форму для привязки задач к выполнению чека программы обслуживания
        /// </summary>
        public DirectivePackageBindTaskForm(IDirectivePackage directivePackage)
            : this()
        {
