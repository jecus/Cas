...
namespace CAS.UI.UIControls.CommercialControls
{
    ///<summary>
    ///</summary>
    public partial class RequestScreen : ScreenControl
    {
        #region Fields

        private bool _needReload;
        private Request _currentItem;
        ...
        #region private RequestScreen()
        ///<summary>
        ///</summary>
        private RequestScreen()
        {
            InitializeComponent();
        }
        #endregion

        #region public RequestScreen(Request request) : this ()

        ///<summary>
        /// Создает страницу для отображения информации об одной директиве
        ///</summary>
        /// <param name="request">Директива</param>
        public RequestScreen(Request request)
            : this()
        {
            if (request == null)
        ...
        protected override void AnimatedThreadWorkerDoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    _currentItem = GlobalObjects.PackageCore.GetDirectivePackage<Request, RequestRecord>(_currentItem.ItemId, true);
                }
            }
            catch (Exception ex)
            {
        ...
        private bool SaveData()
        {
            ...
            try
            {
                ...
                foreach (RequestRecord categoryRecord in _currentItem.PackageRecords)
                {
