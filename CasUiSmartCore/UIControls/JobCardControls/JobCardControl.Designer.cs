...
namespace CAS.UI.UIControls.JobCardControls
{
	partial class JobCardControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.comboBoxMMRef.MouseWheel += CmbScrollHelper.ComboBoxScroll_MouseWheel;
			// 
			// labelJobDescroption
			// 
			...
			this.comboBoxQualification.MouseWheel += CmbScrollHelper.ComboBoxScroll_MouseWheel;
			// 
			// textboxTitle
			// 
