...
namespace CAS.UI.UIControls.ComponentControls
{
	...
	public partial class ComponentGeneralInformationControl : UserControl
	{
		...
		#region public bool IsRVSM

		public bool IsRVSM
		{
			get { return checkBoxRVSM.Checked; }
			set { checkBoxRVSM.Checked = value; }
		}

		#endregion

		#region public bool IsETOPS

		public bool IsETOPS
		{
			get { return checkBoxETOPS.Checked; }
			set { checkBoxETOPS.Checked = value; }
		}
		...
		public bool GetChangeStatus()
		{
			try
			{
				if (ATAChapter != _currentComponent.ATAChapter ||
					...
					IsRVSM != _currentComponent.IsRVSM ||
					IsETOPS != _currentComponent.IsETOPS ||
		...
		public void ApplyChanges(Component component)
		{
			...
			component.IsRVSM = IsRVSM;
			component.IsETOPS = IsETOPS;
