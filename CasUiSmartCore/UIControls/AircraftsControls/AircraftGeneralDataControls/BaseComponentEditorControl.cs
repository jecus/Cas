...
namespace CAS.UI.UIControls.AircraftsControls.AircraftGeneralDataControls
{
    ...
    public sealed partial class BaseComponentEditorControl : UserControl
    {
        ...
        /// <summary>
        /// ¬озвращает значение, показывающее €вл€етс€ ли значение элемента управлени€ допустимым
        /// </summary>
        /// <returns></returns>
        public bool ValidateData(out string message)
        {
            ...
            #region ѕоиск проверочного значени€ даты-времени
            //поиск минимального значени€ даты-времени среди значений
            ...
            if (_currentBaseComponent.ItemId > 0)
            {
                ...
                {
                    // ƒеталь была перемещена откуда - то,
                    // ќграничением будет дата начала перемещени€
        ...
        /// <summary>
        /// ¬озвращает значение, показывающее были ли изменени€ в данном элементе управлени€
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// —охрана€ет данные текущего базового агрегата
        /// </summary>
        public void SaveData()
        {
            ...
            if(_currentBaseComponent.ItemId > 0)
            {
                #region јктуальное состо€ние на стартовую дату
                         ...
                         : !lifelengthViewerInstallation.Lifelength.IsNullOrZero()))
                {
                    ...
                    if (actual != null)
                    {
                        ...
                        {
                            //ƒата установки изменена на более раннюю
        ...
        /// <summary>
        /// ќбновл€ет информацию о базовом агрегате текущего ¬—
        /// </summary>
        ...
        #region Events
        /// <summary>
        /// —обытие, сигнализирующее об удалении св€зной базовой детали
        /// </summary>
