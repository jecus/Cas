...
namespace CAS.UI.UIControls.AircraftsControls.AircraftGeneralDataControls
{
    ...
    public partial class BaseComponentSummaryCollectionControl : UserControl
    {
		...
		#region public BaseComponentSummaryCollectionControl(Aircraft aircraft, BaseComponentType componentType) : this()
		///<summary>
		///</summary>
		public BaseComponentSummaryCollectionControl(Aircraft aircraft, BaseComponentType componentType)
            : this()
        {
