...
namespace CAS.UI.UIControls.AircraftsControls.AircraftGeneralDataControls
{
    ...
    public partial class BaseComponentEditorCollectionControl : UserControl
    {
		...
		#region public BaseComponentEditorCollectionControl(Aircraft aircraft, DetailType detailType) : this()
		///<summary>
		///</summary>
		public BaseComponentEditorCollectionControl(Aircraft aircraft, BaseComponentType componentType) : this()
        {
