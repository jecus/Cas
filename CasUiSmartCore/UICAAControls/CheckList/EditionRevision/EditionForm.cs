    ...
    public partial class EditionForm : MetroForm
    {
        ...
        private void buttonOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var ds = GlobalObjects.CaaEnvironment.Execute($"select top 1 EffDate from [dbo].[CheckListRevision] where EffDate >= '{dateTimePickerEditionEff.Value:yyyy-MM-dd}' and ItemId != {_edition.ItemId} and Type = 0 order by EffDate desc");
