...
WHERE rn = 1 and  IsDeleted = 0");
		...
		{
			var form = new CheckMoveToForm(_directivesViewer.SelectedItem.ItemId, _parentId, _directivesViewer.SelectedItem.AuditCheck.Settings.WorkflowStageId, _directivesViewer.SelectedItem.IsEditable);
