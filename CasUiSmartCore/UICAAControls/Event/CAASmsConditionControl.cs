...
namespace CAS.UI.UICAAControls.Event
{
    ...
    ///</summary>
    public partial class CAASmsConditionControl : EditObjectControl
    {
        ...
        /// </summary>
        public CAAEventCondition EventCondition
        {
            get { return AttachedObject as CAAEventCondition; }
        ...
        /// </summary>
        private CAASmsConditionControl()
        {
            InitializeComponent();
        }
        #endregion
        ...
        /// </summary>
        public CAASmsConditionControl(CAAEventCondition eventCondition)
            : this()
        {
        ...
        private void InitTree()
        {
            ...
            var aircraftModels = GlobalObjects.CaaEnvironment.NewLoader.GetObjectList<CAAAccessoryDescriptionDTO, AircraftModel>(new Filter("ModelingObjectTypeId", 7));
