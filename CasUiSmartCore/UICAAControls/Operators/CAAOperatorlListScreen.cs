...
namespace CAS.UI.UICAAControls.Operators
{
	...
	public partial class CAAOperatorlListScreen : ScreenControl
	{
		...
		private CommonCollection<AllOperators> _initialDocumentArray = new CommonCollection<AllOperators>();
		private CommonCollection<AllOperators> _resultDocumentArray = new CommonCollection<AllOperators>();
		...
		public CAAOperatorlListScreen(Operator currentOperator)
			: this()
		{
			...
			_filter = new CommonFilterCollection(typeof(IAllOperatorFilterParams));
		...
		{
			_directivesViewer = new CAAOperatorlListView(AnimatedThreadWorker);
		...
		private void FilterItems(IEnumerable<AllOperators> initialCollection, ICommonCollection<AllOperators> resultCollection)
		{
