...
namespace CAS.UI.UICAAControls.Document
{
	///<summary>
	///</summary>
	[ToolboxItem(false)]
	public partial class CAADocumentationListScreen : ScreenControl
	{
		...
		///</summary>
		public CAADocumentationListScreen()
		{
			InitializeComponent();
		}
		#endregion
			...
			: this()
		{
			...
			_filter = new CommonFilterCollection(typeof(SmartCore.Entities.General.Document));
		...
		private void ShowDocumentFileItemsClick(object sender, EventArgs e)
		{
			...
			try
			{
				...
				GlobalObjects.CaaEnvironment.OpenFile(attachedFile, out message);
				if (message != "")
				{
		...
		private void ButtonDeleteClick(object sender, EventArgs e)
		{
			...
			if (confirmResult == DialogResult.Yes)
			{
				...
				List<SmartCore.Entities.General.Document> selectedItems = new List<SmartCore.Entities.General.Document>();
		...
		private void FilterItems(IEnumerable<SmartCore.Entities.General.Document> initialCollection, ICommonCollection<SmartCore.Entities.General.Document> resultCollection)
		{
