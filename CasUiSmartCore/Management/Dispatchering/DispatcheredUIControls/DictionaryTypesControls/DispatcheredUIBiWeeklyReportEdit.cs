...
{
    public partial class DispatcheredUIBiWeeklyReportEdit : UIBiWeeklyReportEdit, IDisplayingEntity
    {
        public DispatcheredUIBiWeeklyReportEdit()
        {
            InitializeComponent();
            Dock = DockStyle.Fill;
        }
        ...
        {
            if (obj is DispatcheredUIBiWeeklyReportEdit)
            {
                return true;
            }
            return false;
